...
<!-- <header>
    ...
    <?php include('./AdminModals/Admin_filterbuttons.php') ?>
    <?php include('./AdminModals/addstudent_modal.php') ?>
            ...
            <?php foreach ($rows as $row) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#changePasswordModal<?php echo $row['student_id']; ?>">Change Password</button>
                        <!-- <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editInfoModal<?php echo $row['student_id']; ?>">Edit Info</button> -->
                        <!-- <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editInfoModal<?php echo $row['student_id']; ?>">Edit Info</button> -->
                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#AdminviewModal<?php echo $row['student_id']; ?>">View Profile</button>
    ...
    <!-- Start of the modals -->
    <?php foreach ($rows as $row) : ?>
    <?php include('Admin_viewprofile_modal.php'); ?>
    <?php include('./AdminModals/edit_infomodal.php'); ?>
    <?php include('./AdminModals/changepassword_modal.php'); ?>
<?php endforeach; ?>
<!-- End of the modals -->
