...
<div class="modal fade" id="teacher_changePasswordModal<?php echo $row['teacher_number']; ?>" tabindex="-1" aria-labelledby="changePasswordModalLabel" aria-hidden="true">
<div class="modal-dialog  mb-5 mt-0 mx-auto my-auto modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mainDiv">
                    <div class="cardStyle">
                        <form action="./Adminphpfiles/teacher_changepass_student.php" method="POST">
