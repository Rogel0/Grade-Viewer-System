...
<body style="background-color: #F0ECE5;">
    <div class="container">
        <?php
        include("./phpfiles/connection.php");
        include("./StudentComponents/StudentHeader.php");
        include("./StudentComponents/StudentSidebar.php");
        include("./StudentComponents/StudentTime.php");
        include("./StudentComponents/StudentChangePass.php");
        ?>
